...
<div class="panel-container">
    ...
    <a href="{{ '/people.html' | url }}#your-link-destination-3" class="image-panel">
        <img alt=""> {# Consider adding descriptive alt text #}
